...
class MusicOptimizationProblem(Problem):
    ...
    def __fill_with_LLM(self, population:int):
        """
    ...
    def __fill_with_file(self, population:int):
        """
    ...
    def _fill(self, values):
        ...
        if self.evo_config.initialization == "LLM":
            processed_prompts = self.__fill_with_LLM(population)
        else:
            processed_prompts = self.__fill_with_file(population)
